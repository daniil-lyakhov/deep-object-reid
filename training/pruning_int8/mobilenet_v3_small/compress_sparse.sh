...
--config-file /home/automation/dlyakhov/training_extensions/external/deep-object-reid/training/pruning_int8/mobilenet_v3_small/mobilenetv3_small_sparsity.yml \
--gpu-num 1 \
--custom-roots \
