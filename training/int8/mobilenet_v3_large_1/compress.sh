...
--config-file /home/automation/dlyakhov/training_extensions/external/deep-object-reid/training/int8/mobilenet_v3_large_1/mobilenetv3_large.yml \
--gpu-num 1 \
--custom-roots \
...
data.save_dir /home/automation/dlyakhov/training_extensions/external/deep-object-reid/training/int8/mobilenet_v3_large_1/output
