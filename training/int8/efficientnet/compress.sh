...
--config-file /home/automation/dlyakhov/training_extensions/external/deep-object-reid/training/int8/efficientnet/EfficientNet_b0.yml \
--gpu-num 1 \
--custom-roots \
...
data.save_dir /home/automation/dlyakhov/training_extensions/external/deep-object-reid/training/int8/efficientnet/output
